public class Employee {
    ...
    public void validateContactNumber() {
        ...
        if (this.contact_number.matches("\\d+")) {
            throw new RuntimeException("Contact Number Should Only Contain Digits");
        }

        if (this.contact_number.startsWith("0")) {
            throw new RuntimeException("Contact Number Should Starts With 0");
        }
    }
}
